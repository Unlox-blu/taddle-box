...
TADDLEBOX is a **gamified social app**. Think of it as a mix of Instagram's social feed, Discord's communities, a mini-game arcade, a reddit discussion forum, and a real-money reward wallet — all built for the campus crowd.
...
**Phase 2 — Social & Discovery** 6. Community Browse + Community Detail 7. Events Screen 8. Profile Screen (own and other user) 9. Notifications Screen

**Phase 3 — Auth & Secondary** 10. Splash + Onboarding + Welcome 11. Registration (3 steps) + OTP 12. Login + Forgot Password 13. Settings Screen

**Phase 4 — Component Library** 14. Full component library (buttons, inputs, cards, modals, chips, badges) 15. Icon usage guide 16. Color palette + usage rules 17. Animation specs for development
...
_This document is the single source of truth for the product's screens and features. If any feature is unclear or seems to be missing context, please flag it before design work begins._
