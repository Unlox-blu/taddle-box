...
export default function OtpScreen() {
  ...
  const rawParams = useLocalSearchParams<{ signupData?: string; verificationToken?: string }>();
  const signupData = rawParams.signupData ? JSON.parse(rawParams.signupData) : {};
  const verificationToken = rawParams.verificationToken;
