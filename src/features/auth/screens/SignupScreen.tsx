...
import { radii, fontSizes, spacing } from "../../../design-system";
import { useTheme } from "../../../design-system/theme/ThemeProvider";
import LottieView from "lottie-react-native";
import { getCachedLottie, getCachedLottieSync, S3_APP_ICON_LOTTIE_URL } from "../../../infrastructure/media/lottie";
...
export default function SignupScreen() {
  ...
  // @ts-ignore
  const rawParams = useLocalSearchParams<{ socialToken?: string; socialData?: string }>();
  const socialToken = rawParams.socialToken;
  const socialData = rawParams.socialData ? JSON.parse(rawParams.socialData) : undefined;
    ...
    <LinearGradient colors={[themeColors.bg.base, themeColors.bg.surface]} style={styles.container}>
      ...
      >
        ...
        >
          ...
          <TouchableOpacity
            onPress={() =>
              step > 0 ? setStep((s) => s - 1) : router.back()
            }
            style={styles.back}
          >
            <Ionicons
            ...
            <View>
              ...
              <View style={{ marginBottom: 32 }}>
                {lottieSource ? (
                  ...
                  <Image 
                    source={require('../../../../assets/images/taddlebox-logo.png')} 
