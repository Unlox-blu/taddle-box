...
import SwitchAccountSection from "../components/SwitchAccountSection";
  ...
  useEffect(() => {
    SecureStore.getItemAsync("auth_redirect_forgot_password").then(async (identifier) => {
      if (identifier) {
        ...
        router.push({ pathname: "/forgot-password", params: { initialIdentifier: identifier } });
      }
    });
  }, []);
            ...
            if (resultData.action === "REGISTER_SOCIAL") {
              router.push({
                ...
                params: {
                  ...
                  socialData: JSON.stringify(resultData.data),
                },
              });
              return;
            }
