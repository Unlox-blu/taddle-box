...
import { usePosts } from "../../feed/state/PostsProvider";
import { useJoinCommunity } from "../mutations/community.mutations";
import { communityService } from "../api/community.api";
import { postsService } from "../../posts/api/posts.api";
import PostCard from "../../feed/components/content-cards/types/post-card/PostCard";
...
import { useCommunityPosts } from "../../feed/queries/feed.queries";
import type { CommunityStackParamList, Post, Community } from "../../../shared/types";
import { stageScreenParams } from "../../../shared/state/screen-params";
import { themedAlert } from "../../../design-system/components/ThemedAlert";
import BioText from "../../users/components/BioText";
        ...
        >
          ...
          {isOwner && (
            <TouchableOpacity
              ...
              onPress={() => {
                router.push(`/community/settings/${community.slug}`);
              }}
            >
