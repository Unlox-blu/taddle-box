...
import { useCommunities, useCommunityCategories } from "../queries/community.queries";
import {
  useJoinCommunity,
  useCreateCommunity,
} from "../mutations/community.mutations";
import type { Community } from "../../../shared/types";
import MainHeader from "../../../shell/components/MainHeader";
import { SectionHeader } from "../../../shared/components/SectionChrome";
import * as ImagePicker from "expo-image-picker";
import * as FileSystem from "expo-file-system";
import { mediaService } from "../../posts/api/media.api";
              ...
              {trendingCommunities.map((c, i) => (
                ...
                >
                  <FeaturedCommunityCard
                    ...
                    styles={styles}
                    onPress={() =>
                      router.push(`/community/${c.slug}` as never)
                    }
    ...
    <View style={styles.container}>
            ...
            actions={[
              {
                icon: "trophy-outline",
                onPress: () =>
                  router.push({ pathname: "/leaderboards", params: { initialTab: "Community" } } as never),
              },
            ]}
      ...
      <CreateCommunityModal
        ...
        onCreate={async (formData) => {
          ...
          if (slug) {
            router.push(`/community/${slug}` as never);
          }
        }}
        styles={styles}
        colors={colors}
