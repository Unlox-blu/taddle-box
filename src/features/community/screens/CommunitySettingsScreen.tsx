    ...
    <View style={[styles.container, { paddingTop: insets.top }]}>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        {community.privacy === 'private' && (
          <TouchableOpacity style={styles.rowBtn} onPress={() => router.push(`/community/manage-requests/${community.id}`)}>
        ...
        {(community.ownerId === authUser?.id || ['admin', 'moderator'].includes(community.memberRole)) && (
          <TouchableOpacity style={styles.rowBtn} onPress={() => router.push(`/community/moderation-log/${community.id}`)}>
            <View style={styles.rowBtnLeft}>
