...
import SmartInput from "../../../../../../posts/components/SmartInput";
import { AudiencePickerList } from "../../../../../../posts/components/AudiencePicker";
import { useMyCommunities } from "../../../../../../community/queries/community.queries";
import { themedAlert } from "../../../../../../../design-system/components/ThemedAlert";
import PostMenuSheet from "../../../../../../posts/components/PostMenuSheet";
import PollBlock from "../../../../../../posts/components/PollBlock";
import { RollingText } from "./PostCardShared";
                ...
                return (
                  <View style={{ flexDirection: "row", alignItems: "center", gap: 10, paddingVertical: 8 }}>
                    ...
                    <TouchableOpacity
                      ...
                      onPress={() => {
                        onClose();
                        router.push(`/user/${u?.username || u?.id}` as never);
                      }}
                    >
