...
import FeedSkeleton from "../../../design-system/components/FeedSkeleton";
import CommentsModal from "../../posts/components/CommentsModal";
import { useAuth } from "../../auth/state/AuthProvider";
import { useWallet } from "../../wallet/state/WalletProvider";
import SharedFeed from "../components/SharedFeed";
import { useFeed } from "../queries/feed.queries";
import { useToggleLike, useToggleSave } from "../mutations/content.mutations";
import { useQueryClient } from "@tanstack/react-query";
import { queryKeys } from "../../../shared/state/query-keys";
import type { Post, HomeStackParamList } from "../../../shared/types";

import { streakService } from "../../progression/api/streak.api";
...
import { cycleInfo, isSameDay } from "../../progression/logic/streak.logic";
...
export default function HomeScreen() {
  ...
  const handleDeletePost = async (post: Post) => {
    try {
      const { postsService } = require("../../posts/api/posts.api");
        ...
        ListHeaderComponent={
          <View>
                  ...
                  <TouchableOpacity
                    ...
                    onPress={() => {
                      if (CURRENT_USER?.globalAccountLockEnabled) {
                        ...
                        router.navigate("/wallet" as never);
                      }
                    }}
                    activeOpacity={0.8}
                  >
            ...
            >
              ...
              <TouchableOpacity
                onPress={() =>
                  router.push({ pathname: "/leaderboards", params: { initialTab: "Feed" } } as never)
                }
              >
                <Ionicons
                  name="trophy-outline"
