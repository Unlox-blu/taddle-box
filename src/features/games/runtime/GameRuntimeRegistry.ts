...
import { APP_VERSION } from "../../../infrastructure/config/app-version";
import type { RuntimeContract, RuntimeFeature } from "./game-runtime.types";
...
const RUNTIME_TO_COMPONENT: Record<string, React.LazyExoticComponent<any>> = {
  "chess@1":        React.lazy(() => import("./chess/ChessRuntime")),
  "ludo@1":         React.lazy(() => import("./ludo/LudoRuntime")),
  "snake-ladder@1": React.lazy(() => import("./snake-ladder/SnakeLadderRuntime")),
  "scribble@1":     React.lazy(() => import("./scribble/ScribbleRuntime")),
  "word-rush@1":    React.lazy(() => import("./word-rush/WordRushRuntime")),
  "tap-rush@1":     React.lazy(() => import("./tap-rush/TapRushRuntime")),
  "memory-grid@1":  React.lazy(() => import("./memory-grid/MemoryGridRuntime")),
};
...
export function preloadRuntime(runtime: string, version: number): Promise<any> | undefined {
  ...
  const map: Record<string, () => Promise<any>> = {
    ...
    'snake-ladder@1': () => import('./snake-ladder/SnakeLadderRuntime'),
    'scribble@1': () => import('./scribble/ScribbleRuntime'),
    'word-rush@1': () => import('./word-rush/WordRushRuntime'),
