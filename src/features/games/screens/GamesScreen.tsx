...
import TournamentLeaderboardModal from "../components/TournamentLeaderboardModal";
import {
  gameSound,
  destroyGameSound,
  useGameSoundPrefs,
...
// Game rendering is runtime-driven via GameHost.
// No hardcoded GAME_COMPONENTS map — GameHost routes by runtimeType + runtime
...
export default function GamesScreen() {
  ...
  useEffect(() => {
    const openGameId = params.openGameId || params.gameName;
    ...
    (request: any, response: MatchmakingResponse) => {
      ...
      gamesService
        ...
        .then((res) => {
          ...
          // into the game object so GameHost and the asset system can use
