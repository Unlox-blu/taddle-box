...
import { warn, error } from '../../../infrastructure/logging/logger';
...
export default function NotificationsScreen() {
  ...
  // Refetch whenever the screen regains focus (banner tap / back navigation).
  useFocusEffect(
    React.useCallback(() => {
      fetchNotifs();
    }, [fetchNotifs]),
        ...
        if (resourceId) {
          try {
            ...
            if (post) {
              ...
              stageScreenParams('reel', { post: post as Post, commentId, feedContext: 'notifications' });
