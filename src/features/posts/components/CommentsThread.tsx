        ...
        if (mentionMatch) {
          ...
          return (
            <Text
              ...
              onPress={() => {
                const user = { id, name, username: name } as any;
        ...
        if (part.startsWith('@')) {
          return (
            <Text
              ...
              style={{ color: colors.primaryLight, fontWeight: '600' }}
              onPress={() => {
                const user = { id: part.slice(1), name: part.slice(1), username: part.slice(1) } as any;
                stageScreenParams('user', { user });
                router.push(`/user/${user.username || user.id}`);
              }}
            >
          ...
          <TouchableOpacity
            onPress={() => {
              ...
              if (author?.id || author?.username) {
                stageScreenParams('user', { user: author as any });
