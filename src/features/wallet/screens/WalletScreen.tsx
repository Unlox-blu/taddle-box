...
import * as LocalAuthentication from "../../auth/logic/local-auth";
...
import { themedAlert, notifyModalOpen, notifyModalClose, registerModalCloser } from "../../../design-system/components/ThemedAlert";
import RemovePinModal from "../../posts/components/RemovePinModal";
            ...
            <View style={styles.earnGrid}>
              {earnActions.map((e) => (
                <TouchableOpacity
                  ...
                  onPress={() =>
                    router.navigate(e.tab === "Games" ? "/games" : "/")
                  }
                  activeOpacity={0.75}
                >
                  <Ionicons
