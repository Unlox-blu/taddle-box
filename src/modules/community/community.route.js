...
const { communityController }        = require('./community.container');
const { verifyToken, optionalAuth }  = require('../../middlewares/auth.middleware');
const { authorize }                  = require('../../middlewares/authorized.middleware');
const { validate }                   = require('../../middlewares/validator.middleware');
const { createCommunitySchema, updateCommunitySchema, updateAvatarSchema, updateBannerSchema } = require('./community.validator');
