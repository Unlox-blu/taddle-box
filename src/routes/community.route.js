...
router.post('/',                                       verifyToken,  validate(createCommunitySchema), communityController.create);
router.get('/:slug',                                   optionalAuth, communityController.getBySlug);
router.patch('/:communityId',                          verifyToken,  validate(updateCommunitySchema), communityController.update);
