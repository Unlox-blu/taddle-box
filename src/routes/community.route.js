...
router.get('/:communityId/moderation-log',             verifyToken,  validateRequest({params: communityIdParamsSchema}),          communityController.getModerationLog);
...
router.patch('/:communityId/members/:userId/role',      verifyToken,  validateRequest({params: communityIdAndUserIdParamsSchema, body: updateMemberRoleSchema}), communityController.updateMemberRole);
router.post('/:communityId/transfer-ownership',         verifyToken,  validateRequest({params: communityIdParamsSchema, body: transferOwnershipSchema}), communityController.transferOwnership);
