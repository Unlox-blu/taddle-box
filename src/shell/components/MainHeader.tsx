...
export default function MainHeader({
  ...
  const shouldHideNotif = hideNotifIcon || pathname === "/notifications";
    ...
    >
      ...
      >
        ...
        <Image
          ...
          source={require("../../../assets/images/taddlebox-banner.png")}
          style={{
            height: 28,
            width: 140,
            resizeMode: "contain",
        ...
        <TouchableOpacity
          ...
          onPress={() => {
            ...
            if (pathname === "/") tab = "all";
              ...
              tab = "posts";
              authorFilter = pathname.split("/")[2] || currentUser?.username;
            } else if (pathname === "/community") type = "communities";
            else if (pathname.startsWith("/community/")) {
              tab = "posts";
              scopeCommunity = pathname.split("/")[2];
            } else if (pathname === "/events") type = "events";
            else if (pathname === "/games") type = "games";
            // Search from Wallet is scoped to the user's transactions.
            else if (pathname === "/wallet") source = "wallet";
            else if (pathname === "/chat") source = "messages";
            else if (pathname.startsWith("/chat/")) source = "messages";
