...
import { View, StyleSheet, Image, DeviceEventEmitter, Platform } from "react-native";
import Animated, {
  useSharedValue,
  useAnimatedStyle,
  withSpring,
...
import SectionChrome from "../../shared/components/SectionChrome";
import {
  useGlobalScroll,
    ...
    <GestureDetector gesture={panGesture}>
      <View style={styles.container}>
        ...
        <Animated.View style={[styles.content, animatedStyle]}>
          {header}
          {/* NativeViewGestureHandler requires its child to be a native
              scrollable — react-native-web can't satisfy that, so on web the
              content renders directly (no gesture coordination needed; the
